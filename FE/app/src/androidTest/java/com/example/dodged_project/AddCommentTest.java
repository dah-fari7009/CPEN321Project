...
//    @Rule
//    public ActivityScenarioRule<PlayerProfileActivity> mPlayerProfileActivity =
//            new ActivityScenarioRule<>(PlayerProfileActivity.class);
    ...
    public void addCommentTest() {
        ...
        ViewInteraction textInputEditText3 = onView(
                allOf(withId(R.id.username_03_textinput),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText3.perform(replaceText("TheWanderersWay"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText6 = onView(
                allOf(withId(R.id.add_comment_textinput),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.outlinedTextField),
                                        0),
                                0),
                        isDisplayed()));
        textInputEditText6.perform(replaceText("adding a comment" + random), closeSoftKeyboard());

        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.add_comment_button), withText("Add Comment"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.comment_textview_and_add_button),
                                        0),
                                1),
                        isDisplayed()));
        materialButton4.perform(click());

        onView(withText("adding a comment" + random)).check(matches(withText("adding a comment" + random)));
    }
