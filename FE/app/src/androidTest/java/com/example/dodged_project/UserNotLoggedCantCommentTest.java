...
public class UserNotLoggedCantCommentTest {
    ...
    @Test
    public void userNotLoggedCantCommentTest() {
        ...
        device.wait(Until.findObject(By.res("com.example.dodged_project:id/log_in_to_comment_hint")), 5000);

        ViewInteraction textView2 = onView(
                allOf(withText("Please login to comment on the player's profile"),
                        withParent(withParent(withId(R.id.log_in_to_comment_hint))),
                        isDisplayed()));
        textView2.check(matches(withText("Please login to comment on the player's profile")));
    }
