...
public class SelectChampTest {
    ...
    public void selectChampTest() {
        ...
        ViewInteraction spinner = onView(
                allOf(withId(R.id.champion_dropdown_item), withText("Aatrox"),
                        withParent(withParent(withId(R.id.champion_dropdown_menu))),
                        isDisplayed()));
