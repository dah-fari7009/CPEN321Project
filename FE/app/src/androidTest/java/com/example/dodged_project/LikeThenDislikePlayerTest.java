...
public class LikeThenDislikePlayerTest {
    ...
    @Test
    public void likeThenDislikePlayerTest() {
        ...
        onData(anything()).inAdapterView(withId(android.R.id.list)).atPosition(0).onChildView(withId(R.id.player_like_button)).atPosition(0).perform(click());
        onData(anything()).inAdapterView(withId(android.R.id.list)).atPosition(0).onChildView(withId(R.id.player_like_button)).atPosition(0).perform(click());
        onData(anything()).inAdapterView(withId(android.R.id.list)).atPosition(0).onChildView(withId(R.id.player_dislike_button)).atPosition(0).perform(click()).check(matches(isDisplayed()));
    }
