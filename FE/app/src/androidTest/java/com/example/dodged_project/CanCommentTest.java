        ...
        ViewInteraction textInputEditText7 = onView(
                allOf(withId(R.id.add_comment_textinput),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText7.perform(replaceText("my comment"), closeSoftKeyboard());

        ViewInteraction editText = onView(
                allOf(withId(R.id.add_comment_textinput), withText("my comment"),
                        withParent(withParent(withId(R.id.outlinedTextField))),
                        isDisplayed()));
        editText.check(matches(withText("my comment")));
    }
