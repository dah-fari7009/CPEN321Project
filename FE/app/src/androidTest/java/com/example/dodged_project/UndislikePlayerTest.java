...
public class UndislikePlayerTest {
    ...
    @Test
    public void undislikePlayerTest() {
        ...
        onData(anything()).inAdapterView(withId(android.R.id.list)).atPosition(0).onChildView(withId(R.id.player_dislike_button)).atPosition(0).perform(click());
