...
public class PlayerStatsScrollTest {
    ...
    @Test
    public void playerStatsScrollTest() {
        ...
        onView(withId(R.id.stats_vision_textview)).perform(scrollTo());

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.stats_vision_textview), withText("0.45"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
