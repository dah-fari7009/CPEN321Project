...
public class CheckChampExpTest {
    ...
    public void checkChampExpTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView3), withText("Top Played Champions"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView2.check(matches(withText("Top Played Champions")));
    }
